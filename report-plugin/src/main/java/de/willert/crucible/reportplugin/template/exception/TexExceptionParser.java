...
public class TexExceptionParser {
    ...
    private List<ExcpetionType> excpetionTypes = Lists.newArrayList(
            ...
            ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Misplaced alignment tab character \\&/")
                                              ...
                                              .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Extra alignment tab has been changed to \\cr/")
                                                                                          ...
                                                                                          .build(), ExcpetionType.ExcpetionTypeBuilder
                    .anExcpetionType().withRegexToMatch("/Display math should end with \\$\\$/")
                    ...
                    .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Missing [{$] inserted./")
                                                                ...
                                                                .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType()
                                                                                                            ...
                                                                                                            .build(), ExcpetionType.ExcpetionTypeBuilder
                    .anExcpetionType().withRegexToMatch("/Citation .+ on page .+ undefined on input line .+/")
            ...
            ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/(Label .+)? multiply[ -]defined( labels)?/")
                                              ...
                                              .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/`!?h' float specifier changed to `!?ht'/")
                                                                                          ...
                                                                                          .build(), ExcpetionType.ExcpetionTypeBuilder
                    .anExcpetionType().withRegexToMatch("/No positions in optional float specifier/")
                    ...
                    .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Undefined control sequence/")
                                                                ...
                                                                .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType()
                                                                                                            ...
                                                                                                            .build(), ExcpetionType.ExcpetionTypeBuilder
                    .anExcpetionType().withRegexToMatch("/LaTeX Error: Unknown graphics extension: \\..+/")
                    ...
                    .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/LaTeX Error: Unknown float option `H'/")
                                                                ...
                                                                .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/LaTeX Error: Unknown float option `q'/")
                    ...
                    .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Error: `([^']{2,})' expected, found `([^']{2,})'.*/")
                                                                .withHumanReadableHint("You have used \\\\begin{...} without a corresponding \\\\end{...}.")
                                                                .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Error: `([^a-zA-Z0-9])' expected, found `([^a-zA-Z0-9])'.*/")
                                                                                                            .withHumanReadableHint("You have used an open bracket without a corresponding close bracket.")
                                                                                                            .build(), ExcpetionType.ExcpetionTypeBuilder
                    .anExcpetionType().withRegexToMatch("/LaTeX Error: Can be used only in preamble/")
                    ...
                    .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType()
                                                                ...
                                                                .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Double superscript/")
                                                                                                            ...
                                                                                                            .build(), ExcpetionType.ExcpetionTypeBuilder
                    .anExcpetionType().withRegexToMatch("/Double subscript/")
                    ...
                    .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/No \\\\author given/")
                                                                ...
                                                                .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType()
                                                                                                            ...
                                                                                                            .build(), ExcpetionType.ExcpetionTypeBuilder
                    .anExcpetionType().withRegexToMatch("/LaTeX Error: Something's wrong--perhaps a missing \\\\item/")
                    ...
                    .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Misplaced \\\\noalign/")
                                                                ...
                                                                .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Error: `\\end\\{([^\\}]+)\\}' expected but found `\\end\\{([^\\}]+)\\}'.*/")
                                                                                                            .withHumanReadableHint("You have used \\begin{} without a corresponding \\end{}.")
                                                                                                            .build(),

            ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Warning: No matching \\\\end found for `\\begin\\{([^\\}]+)\\}'.*/")
                                              .withHumanReadableHint("You have used \\begin{} without a corresponding \\end{}.")
                                              .build(), ExcpetionType.ExcpetionTypeBuilder.anExcpetionType().withRegexToMatch("/Error: Found `\\end\\{([^\\}]+)\\}' without corresponding \\begin.*/")
                                                                                          .withHumanReadableHint("You have used \\begin{} without a corresponding \\end{}.")
                                                                                          .build());
